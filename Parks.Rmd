...
abstract: "Parks, pools, and golf courses."
...
```
Figure 1 displays the park distribution in Austin measured in acreage per 100000 people. Zip code 78701 has the highest acreage per 100000 of 159.12. Alternatively, zip code 78742 the lowest acreage per 100000 of 0. 
...
Figure 3 displays a distinguishable pattern of the location of each outdoor space in terms of respective cluster.
...
```{r, echo=FALSE}
#creates table
table1 = knitr::kable(clust_totals, caption = "Results", digits = 2)
```
