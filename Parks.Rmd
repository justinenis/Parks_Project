...
knitr::kable(clust_totals, "pipe", caption = "Results", digits = 2, col.names = c("Cluster", "Population", "Number of Parks", "Share of Parks", "Total Acres", "Average Acres", "Acres Per 100000"))
```
